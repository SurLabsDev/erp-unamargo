...
- **H4 (siguiente)**: publicación — README con guía de deploy por instancia, smoke checklist, hardening final, riesgos del free tier, deploy real (espera credenciales).
